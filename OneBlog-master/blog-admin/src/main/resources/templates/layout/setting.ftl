        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-sm-12 col-md-12" style="text-align: center;margin: 0 auto;float: initial">
                    <a href="/assets/images/reward/my.jpg" class="showImage" title="支付宝收钱码" rel="external nofollow">
                        <img src="/assets/images/reward/my.jpg" alt="支付宝收钱码" class="img-rounded" style="width: 250px;height: auto;">
                    </a>
                    <a href="/assets/images/reward/mht.jpg" class="showImage" title="微信收钱码" rel="external nofollow">
                        <img src="/assets/images/reward/mht.jpg" alt="微信收钱码" class="img-rounded" style="width: 250px;height: auto">
                    </a>
                </div>
